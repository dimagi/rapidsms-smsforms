...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DecisionTrigger.final_response'
        db.add_column('smsforms_decisiontrigger', 'final_response', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DecisionTrigger.final_response'
        db.delete_column('smsforms_decisiontrigger', 'final_response')
