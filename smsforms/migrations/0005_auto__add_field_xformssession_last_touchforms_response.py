...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XFormsSession.last_touchforms_response'
        db.add_column('smsforms_xformssession', 'last_touchforms_response', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'XFormsSession.last_touchforms_response'
        db.delete_column('smsforms_xformssession', 'last_touchforms_response')
    ...
    models = {
        ...
        'smsforms.xformssession': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_touchforms_response': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
