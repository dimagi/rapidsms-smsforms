...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'XFormsSession.select_text_mode'
        db.add_column('smsforms_xformssession', 'select_text_mode',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'XFormsSession.select_text_mode'
        db.delete_column('smsforms_xformssession', 'select_text_mode')
