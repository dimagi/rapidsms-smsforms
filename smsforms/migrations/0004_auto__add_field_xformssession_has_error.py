...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XFormsSession.has_error'
        db.add_column('smsforms_xformssession', 'has_error', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'XFormsSession.has_error'
        db.delete_column('smsforms_xformssession', 'has_error')
